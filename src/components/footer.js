...
const Footer = props => {
      ...
      <>
        ...
        <nav className="foot__sect__nav foot__sect__nav--share">
          <a
            ...
            className="foot__sect__nav__a a--secondary tw-share-button"
          >
          ...
          <a
            ...
            className="foot__sect__nav__a a--secondary facebook-share-button"
          >
          ...
          <a
            ...
            className="foot__sect__nav__a a--secondary telegram-share-button"
          >
  ...
  return (
    <footer className={`foot--${props.pageClass}`}>
       ...
       */}
        {share}
        <h2 className="foot__sect__header">О контактах</h2>
