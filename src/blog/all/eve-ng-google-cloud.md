...
![Выбираем Start](/images/eve-on-off.jpg)
...
![Синий экран, на этом моменте нельзя вводить пароль, сперва Ctrl + c](/images/eve-bluescreen.jpg)

На моменте с настройкой айпи адреса выбираем DHCP, дальше direct connection.
![](/images/eve-blue-dhcp.jpg)
...
1. Сразу заходим в рут `sudo -i` Переходим к файлу с конфигами интерфейсов редактором nano: `nano /etc/network/interfaces`, здесь видим заголовок Cloud devices. Это всё интерфейсы. Настраиваем первый, чтоб он выглядел так:
   ```
