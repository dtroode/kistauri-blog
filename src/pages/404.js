        ...
        <article key="main__arts__inf">
          <Link to="/">
            <section className="art__cont">
              ...
              <p
                data-text="Все, что нужно знать: дальше пути нет.
                Возможно, ты неправильно ввел ссылку или перешел по удаленной
                странице.
                Но отсюда есть путь назад."
                className="glitch"
              >
                Все, что нужно знать: дальше пути нет.
                <br />
                Возможно, ты неправильно ввел ссылку или перешел по удаленной
                странице.
                <br />
