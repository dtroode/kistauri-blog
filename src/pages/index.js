      ...
      <section className="main__content">
        ...
        <ol className="main__arts">
          <li>
            ...
            <br />
            Целевая аудитория — разработчики, дизайнеры, люди связанные со
            сферой технологий.
            <ul>
              <li>
          ...
          <li>
            ...
            <br />
            Цель — привлечение клиентов через социальные сети, создание каталога
            с букетами и информацией о студии.
            <ul>
              <li>
          ...
          <li>
            ...
            <br />
            Цель — самообучение, создание страницы с доступной и красивой
            основной информацией.
            <br />
            Целевая аудитория — школьники и студенты, которым надо быстро
            подсмотреть значения или подготовиться к контрольной работе.
            <ul>
              <li>
                <strong>Как руководитель</strong>
                <br />
          ...
          <li>
            ...
            школы, презентует школу, который выглядит лучше, чем у конкурентов.
            <br />
            Целевая аудитория — ученики, которые хотят найти информацию о школе:
            расписание, билеты, история, родители, которые хотят выбрать школу
            для ребенка.
            <ul>
              <li>
                <strong>Как руководитель</strong>
          ...
          <li>
            ...
            <br />
            Цель — создание иформационного сайта про Сухум, чтоб было
            минималистично и про контент, а еще тренировка навыков написания
            сайта.
            <br />
            Целевая аудитория — местные жители, которые (почему-то) не знают
            историю города и всякие интересные места, туристы, которые хотят
            выбрать себе отель, ресторан, исторические достопримечательности и
            т. д.
            <ul>
              <li>
                <strong>Как руководитель</strong>
