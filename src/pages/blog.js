        ...
        <section className="articles">
          {postList.edges.map(({ node }) => (
            <article className={node.frontmatter.categories}>
              ...
              <Img fluid={node.frontmatter.hero.childImageSharp.fluid} className="page-background" alt={node.frontmatter.title}/>
          ...
          <Link to="/blog/archive" className="show-more">More...</Link>
        </section>
    </Layout>
  )
}
